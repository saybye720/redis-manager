...
namespace BF\RedisManager;

use BF\RedisManager\DataType\DataType;
use BF\RedisManager\DataType\Hashes;
use BF\RedisManager\DataType\Lists;
use BF\RedisManager\DataType\Sets;
use BF\RedisManager\DataType\SortedSets;
use BF\RedisManager\DataType\Strings;
use BF\RedisManager\Formatter\Information;
use Illuminate\Http\Request;
use Illuminate\Redis\Connections\Connection;
use Illuminate\Support\Collection;
use Illuminate\Support\Facades\PhpRedis;
...
class RedisManager
{
    ...
    public function getConnection($connection = null)
    {
        ...
        return PhpRedis::connection($this->connection);
    }
